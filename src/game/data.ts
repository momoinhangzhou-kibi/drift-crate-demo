...
export const fishList: Fish[] = [
  ...
  { id: "drift-mackerel", name: "漂流青花鱼", emoji: "🐟", rarity: "Common", description: "跟着木筏影子游的小青花鱼，适合做最朴素的烤鱼。", basePrice: 5, weatherHint: ["阴天", "小雨"], timeHint: "午后常见", cookingTag: "basic" },
  ...
  { id: "coral-goby", name: "珊瑚虾虎鱼", emoji: "🐠", rarity: "Uncommon", description: "身上有一点珊瑚色斑纹，像从远方小岛附近游来。", basePrice: 13, weatherHint: ["晴天"], timeHint: "阳光好时", cookingTag: "basic" },
  ...
  { id: "sun-mahi", name: "晴日鬼头刀", emoji: "🌞", rarity: "Rare", description: "晴天海面上闪出金绿光泽，像追着太阳跑。", basePrice: 30, weatherHint: ["晴天", "高温"], timeHint: "阳光最亮时", cookingTag: "rare" },
  ...
  { id: "storm-ray", name: "风暴魟鱼", emoji: "🛸", rarity: "Rare", description: "只有风浪很大时才贴着浪底滑过，像一片会游泳的乌云。", basePrice: 34, weatherHint: ["风暴", "巨浪"], timeHint: "风浪预警时", cookingTag: "rare" },
  { id: "ice-cod", name: "寒潮银鳕", emoji: "❄️", rarity: "Rare", description: "寒潮里才靠近木筏的银白大鱼，煮汤特别暖。", basePrice: 32, weatherHint: ["寒潮"], timeHint: "寒潮夜里", cookingTag: "rare" },
  ...
  { id: "message-bottlefish", name: "漂流瓶鱼", emoji: "🍾", rarity: "Epic", description: "肚子圆圆像玻璃瓶，传说会把远方消息带到木筏旁。", basePrice: 66, weatherHint: ["小雨", "大雾"], timeHint: "潮水换向时", cookingTag: "special" },
  ...
  { id: "tide-dragon", name: "潮汐龙鱼", emoji: "🐉", rarity: "Legendary", description: "据说只会在大潮前后现身，鳞片像把整片海折进去了。", basePrice: 210, weatherHint: ["巨浪", "风暴"], timeHint: "大灾害前后", cookingTag: "legend" },
];
